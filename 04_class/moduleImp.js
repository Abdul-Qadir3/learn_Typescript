...
const modulesExp_4 = require("./modulesExp");
for (let i = 0; i < modulesExp_4.studentObj.length; i++) { //if not used default in export and just written export
    console.log(`Student ID is ${modulesExp_4.studentObj[i].id} and the name is ${modulesExp_4.studentObj[i].name}`);
}
