...
function greetingwithreturnValue(username) {
...
let add5 = (num1, num2) => num1 + num2; // an arrow function, which takes two parameters, "num1" and "num2", both explicitly typed as number. 
