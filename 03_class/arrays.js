...
let numbers = [91, 82, 63, 54, 75, 46, 17, 28, 39];
// index =  0   1  2  3  4  5  6  7  8
let names;
let mixType0 = ["Abdul", "qadir", "10"]; //acts as string,number or boolean at on time 
let mixType1 = [3, 5, 7]; //acts as string,number or boolean at on time 
let mixType2 = [true]; //acts as string,number or boolean at on time 
mixType2.push(true);
mixType0.push("Alpha");
mixType1.push(10);
